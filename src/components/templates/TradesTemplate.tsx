  ...
  return (
    <div className="bg-[#1C1917] aspect-[210/297] font-sans text-[#FEF3C7] pb-6">
      ...
      <div className="bg-[#1C1917] pt-4 pb-3 px-4 flex justify-between items-start">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-[11px] text-[#EA580C] mt-0.5">Trades & General Services</div>
          </div>
        </div>
        <div className="text-right">
          <div className="border border-[#EA580C] text-[#EA580C] px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider mb-1 inline-block">
            {invoice.status}
          </div>
      ...
      <div className="bg-[#292524] border-l-[4px] border-l-[#EA580C] py-2 px-3 mx-4 mb-3">
        <div className="text-[8px] text-[#EA580C] uppercase tracking-wider font-bold mb-0.5">Job Reference</div>
      ...
      <div className="bg-[#292524] rounded-lg p-3 mx-4 mb-3">
        <div className="text-[8px] text-[#EA580C] uppercase tracking-wider font-bold mb-0.5">Balance Due</div>
        ...
        <div className="text-[8px] text-[#EA580C] uppercase tracking-wider font-bold mb-0.5">Billed To</div>
      ...
      <div className="bg-[#292524] rounded-lg overflow-hidden mx-4 mb-3">
        <div className="bg-[#EA580C] py-2 px-3 grid grid-cols-12 gap-2">
          ...
          {items.map((item, i) => (
            <div key={i} className={`p-2.5 grid grid-cols-12 gap-2 border-b border-[#44403C] items-center ${i % 2 === 0 ? 'bg-[#292524]' : 'bg-[#2C2926]'}`}>
              <div className="col-span-6">
                ...
                <div className="text-[10px] text-[#EA580C] italic mt-0.5">Labour / Materials</div>
              </div>
        ...
        <div className="bg-[#1C1917] border-t-2 border-t-[#EA580C] p-2.5 text-right">
          <span className="text-[#EA580C] font-bold text-[14px]">{formatCurrency(invoice.total_amount)}</span>
        </div>
      </div>

      {/* Payment */}
      <div className="bg-[#292524] rounded-lg p-3 mx-4 mb-3">
        <div className="text-[#EA580C] font-bold text-[11px] mb-2">🔧 PAYMENT INSTRUCTIONS</div>
      ...
      <div className="border border-dashed border-[#44403C] p-2.5 mx-4 mb-3">
        <div className="text-[10px] text-[#9CA3AF] italic leading-relaxed">
